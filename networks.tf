...
# Overwrite the default route table of VPC (master) with our route table entries
...
# Overwrite the default route table of VPC (worker) with our route table entries
